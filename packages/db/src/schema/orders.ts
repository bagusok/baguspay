...
export const orders = pgTable(
  'orders',
  {
    ...
    payment_status: paymentStatusEnum('payment_status').notNull().default(PaymentStatus.PENDING),
    order_status: orderStatusEnum('order_status').notNull().default(OrderStatus.NONE),
