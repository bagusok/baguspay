...
export default function ProductSectionDetail({ productSection, productOnProductSections }: Props) {
  ...
  const disconnect = (product_category_id: string) => {
    ...
    router.post(
      `/admin/config/home/fast-menu/${productSection.id}/disconnect-product`,
      { product_category_id },
      {
        preserveScroll: true,
      ...
      <div className="flex flex-col gap-6">
        <div className="flex items-center gap-4">
          <Button variant="ghost" size="sm" asChild>
            <Link href="/admin/config/home/fast-menu">
        ...
        <div className="flex items-start justify-between">
          <div>
            <h1 className="text-2xl font-bold">Detail Fast Menu</h1>
            ...
            <CardContent className="space-y-3">
              ...
              {productSection.category && (
                <div>
                  ...
                  <p className="text-sm">{productSection.category}</p>
                </div>
              )}
