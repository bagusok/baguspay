...
export default function EditProductCategory(
  props: InferPageProps<ProductsCategoriesController, 'editGames'>
) {
  const { data, errors, setData, patch, processing } = useForm('editGames', {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault()
    patch(`/admin/product-categories/game/${props.productCategory.id}`, {
      onSuccess: () => {
