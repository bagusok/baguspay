...
export default function CreateProductCategory() {
  const { data, errors, setData, post, processing } = useForm<CreateProductCategoryValidator>(
    'createbpjsketenagakerjaan',
    {
      ...
      type: ProductCategoryType.BPJS_KETENAGAKERJAAN_POSTPAID,
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault()
    post('/admin/product-categories/bpjs-ketenagakerjaan/create', {
      onSuccess: () => {
  ...
  return (
    <AdminLayout>
      <h2 className="text-2xl font-bold mt-4">Create BPJS Ketenagakerjaan Product Category</h2>
