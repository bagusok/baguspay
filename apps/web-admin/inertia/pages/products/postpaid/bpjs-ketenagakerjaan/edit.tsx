...
export default function EditProductCategory(
  props: InferPageProps<ProductsCategoriesPostpaidController, 'editBPJSKetenagakerjaan'>
) {
  const { data, errors, setData, patch, processing } = useForm('editbpjsketenagakerjaan', {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault()
    patch(`/admin/product-categories/bpjs-ketenagakerjaan/${props.productCategory.id}`, {
      onSuccess: () => {
  ...
  return (
    <AdminLayout>
      <h2 className="text-2xl font-bold mt-4">Edit BPJS Ketenagakerjaan Product Category</h2>
