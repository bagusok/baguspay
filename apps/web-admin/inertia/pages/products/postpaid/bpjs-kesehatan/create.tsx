...
export default function CreateProductCategory() {
  const { data, errors, setData, post, processing } = useForm<CreateProductCategoryValidator>(
    'createbpjskesehatan',
    {
      ...
      type: ProductCategoryType.BPJS_KESEHATAN_POSTPAID,
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault()
    post('/admin/product-categories/bpjs-kesehatan/create', {
      onSuccess: () => {
  ...
  return (
    <AdminLayout>
      <h2 className="text-2xl font-bold mt-4">Create BPJS Kesehatan Product Category</h2>
