...
export default function CreateProductCategory() {
  ...
  return (
    <AdminLayout>
      <h2 className="text-2xl font-bold mt-4">Create Voucher Product Category</h2>
      <form className="w-full mx-auto bg-white rounded-lg space-y-4 mt-6" onSubmit={handleSubmit}>
        ...
        {/* <div className="flex items-center gap-2">
          <Switch
            ...
            onCheckedChange={(val) => setData('is_special_feature', val)}
          />
          <Label htmlFor="is_special_feature" className="mb-2">
            Special Feature
          </Label>
        </div>
