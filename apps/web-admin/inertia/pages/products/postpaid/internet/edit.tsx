...
export default function EditProductCategory(
  props: InferPageProps<ProductsCategoriesPostpaidController, 'editInternet'>
) {
  const { data, errors, setData, patch, processing } = useForm('editinternet', {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault()
    patch(`/admin/product-categories/internet/${props.productCategory.id}`, {
      onSuccess: () => {
  ...
  return (
    <AdminLayout>
      <h2 className="text-2xl font-bold mt-4">Edit Internet Product Category</h2>
