...
export default function EditProductCategory(
  props: InferPageProps<ProductsCategoriesPostpaidController, 'editPDAM'>
) {
  const { data, errors, setData, patch, processing } = useForm('editpdam', {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault()
    patch(`/admin/product-categories/pdam/${props.productCategory.id}`, {
      onSuccess: () => {
  ...
  return (
    <AdminLayout>
      <h2 className="text-2xl font-bold mt-4">Edit PDAM Product Category</h2>
