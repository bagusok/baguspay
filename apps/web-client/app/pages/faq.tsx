      ...
      <section className="mt-6 relative overflow-hidden rounded-2xl bg-linear-to-br from-primary/10 via-secondary/10 to-transparent p-6 md:p-10 border border-border">
        <div className="relative z-10">
          ...
          <p className="mt-3 md:mt-4 text-sm md:text-base text-muted-foreground max-w-3xl">
            Temukan jawaban cepat untuk pertanyaan umum. Jika masih butuh bantuan, hubungi tim kami.
          </p>
        </div>
        ...
        <div className="divide-y divide-border">
          {faqs.map((item) => (
            <details key={randId} className="group py-3">
              ...
              <div className="mt-2 text-sm text-muted-foreground leading-6">{item.a}</div>
            </details>
          ))}
        </div>
      </section>
