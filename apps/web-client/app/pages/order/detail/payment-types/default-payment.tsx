...
export default memo(function DefaultPayment({ paymentName, paymentType }: Props) {
  return (
    <div className="space-y-3">
      <div className="p-4 bg-gray-50 dark:bg-gray-900/20 border border-gray-200 dark:border-gray-800/30 rounded-lg">
        <div className="flex items-center justify-center gap-2 mb-2">
          ...
          <p className="text-sm text-gray-800 dark:text-gray-300 font-medium">{paymentName}</p>
        </div>
