...
export default memo(function BankTransferPayment({ payCode, paymentType, onCopy }: Props) {
  const title = useMemo(() => {
    return paymentType === 'virtual_account' ? 'Nomor Virtual Account' : 'Kode Transfer'
  }, [paymentType])
